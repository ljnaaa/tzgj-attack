...
void protobuf_AssignDesc_decision_2eproto() {
  ...
  static const int DecisionConfig_offsets_[15] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DecisionConfig, goal_bot_),
  };
...
void protobuf_AddDesc_decision_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    " \001(\0132\027.roborts_decision.Point\"\302\005\n\016Decisi"
    ...
    "sion.Point\022.\n\010goal_bot\030\017 \001(\0132\034.roborts_d"
    "ecision.MultiRobot", 1218);
...
const int DecisionConfig::kGoalBotFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
...
void DecisionConfig::InitAsDefaultInstance() {
  ...
  goal_bot_ = const_cast< ::roborts_decision::MultiRobot*>(&::roborts_decision::MultiRobot::default_instance());
}
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[8 / 32] & 17152u) {
    ...
    if (has_goal_bot()) {
      if (goal_bot_ != NULL) goal_bot_->::roborts_decision::MultiRobot::Clear();
    }
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 14: {
        ...
        if (input->ExpectTag(114)) goto parse_loop_search_region_4;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(122)) goto parse_goal_bot;
        break;
      }

      // optional .roborts_decision.MultiRobot goal_bot = 15;
      case 15: {
        if (tag == 122) {
         parse_goal_bot:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_goal_bot()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectAtEnd()) goto success;
...
::google::protobuf::uint8* DecisionConfig::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_goal_bot()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        15, *this->goal_bot_, false, target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:roborts_decision.DecisionConfig)
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_goal_bot()) {
      mutable_goal_bot()->::roborts_decision::MultiRobot::MergeFrom(from.goal_bot());
    }
  }
  if (from._internal_metadata_.have_unknown_fields()) {
    mutable_unknown_fields()->MergeFrom(from.unknown_fields());
...
void DecisionConfig::InternalSwap(DecisionConfig* other) {
  ...
  std::swap(goal_bot_, other->goal_bot_);
  std::swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
// optional .roborts_decision.MultiRobot goal_bot = 15;
bool DecisionConfig::has_goal_bot() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
void DecisionConfig::set_has_goal_bot() {
  _has_bits_[0] |= 0x00004000u;
}
void DecisionConfig::clear_has_goal_bot() {
  _has_bits_[0] &= ~0x00004000u;
}
void DecisionConfig::clear_goal_bot() {
  if (goal_bot_ != NULL) goal_bot_->::roborts_decision::MultiRobot::Clear();
  clear_has_goal_bot();
}
const ::roborts_decision::MultiRobot& DecisionConfig::goal_bot() const {
  // @@protoc_insertion_point(field_get:roborts_decision.DecisionConfig.goal_bot)
  return goal_bot_ != NULL ? *goal_bot_ : *default_instance_->goal_bot_;
}
::roborts_decision::MultiRobot* DecisionConfig::mutable_goal_bot() {
  set_has_goal_bot();
  if (goal_bot_ == NULL) {
    goal_bot_ = new ::roborts_decision::MultiRobot;
  }
  // @@protoc_insertion_point(field_mutable:roborts_decision.DecisionConfig.goal_bot)
  return goal_bot_;
}
::roborts_decision::MultiRobot* DecisionConfig::release_goal_bot() {
  // @@protoc_insertion_point(field_release:roborts_decision.DecisionConfig.goal_bot)
  clear_has_goal_bot();
  ::roborts_decision::MultiRobot* temp = goal_bot_;
  goal_bot_ = NULL;
  return temp;
}
void DecisionConfig::set_allocated_goal_bot(::roborts_decision::MultiRobot* goal_bot) {
  delete goal_bot_;
  goal_bot_ = goal_bot;
  if (goal_bot) {
    set_has_goal_bot();
  ...
  // @@protoc_insertion_point(field_set_allocated:roborts_decision.DecisionConfig.goal_bot)
}
