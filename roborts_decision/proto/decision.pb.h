...
class DecisionConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_decision.DecisionConfig) */ {
 public:
  ...
  bool has_goal_bot() const;
  void clear_goal_bot();
  static const int kGoalBotFieldNumber = 15;
  const ::roborts_decision::MultiRobot& goal_bot() const;
  ::roborts_decision::MultiRobot* mutable_goal_bot();
  ::roborts_decision::MultiRobot* release_goal_bot();
  void set_allocated_goal_bot(::roborts_decision::MultiRobot* goal_bot);
 ...
 private:
  ...
  inline void set_has_goal_bot();
  inline void clear_has_goal_bot();
  ...
  ::roborts_decision::MultiRobot* goal_bot_;
  bool simulate_;
  bool master_;
  friend void  protobuf_AddDesc_decision_2eproto();
  friend void protobuf_AssignDesc_decision_2eproto();
...
// optional .roborts_decision.MultiRobot goal_bot = 15;
inline bool DecisionConfig::has_goal_bot() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void DecisionConfig::set_has_goal_bot() {
  _has_bits_[0] |= 0x00004000u;
}
inline void DecisionConfig::clear_has_goal_bot() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void DecisionConfig::clear_goal_bot() {
  if (goal_bot_ != NULL) goal_bot_->::roborts_decision::MultiRobot::Clear();
  clear_has_goal_bot();
}
inline const ::roborts_decision::MultiRobot& DecisionConfig::goal_bot() const {
...
inline ::roborts_decision::MultiRobot* DecisionConfig::mutable_goal_bot() {
  set_has_goal_bot();
  if (goal_bot_ == NULL) {
...
inline ::roborts_decision::MultiRobot* DecisionConfig::release_goal_bot() {
...
inline void DecisionConfig::set_allocated_goal_bot(::roborts_decision::MultiRobot* goal_bot) {
  delete goal_bot_;
  goal_bot_ = goal_bot;
  if (goal_bot) {
    set_has_goal_bot();
